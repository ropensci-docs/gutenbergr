# Contributing to gutenbergr

This outlines how to propose a change to gutenbergr.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/gutenbergr", fork = TRUE)`.
...
- New code should follow the styling and formatting provided by
...
- We use [testthat](https://cran.r-project.org/package=testthat) for
  ...
  See the [`tests` `README`](https://docs.ropensci.org/tests/README.md)
  for info.

## Code of Conduct

Please note that the gutenbergr project is released with [rOpenSci’s
